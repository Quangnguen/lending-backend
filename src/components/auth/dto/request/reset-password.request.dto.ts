...
export class ResetPasswordRequestDto extends BaseDto {
  @ApiProperty({ description: 'Email tài khoản cần đặt lại mật khẩu', example: 'user@example.com' })
  @IsNotEmpty()
  @IsEmail()
  email: string;

  @ApiProperty({ description: 'Mã OTP 6 chữ số đã gửi về email', example: '123456' })
  @IsNotEmpty()
  @IsString()
  otp: string;
